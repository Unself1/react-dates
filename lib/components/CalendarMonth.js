...
var CalendarMonth = function (_React$Component) {
  ...
  _createClass(CalendarMonth, null, [{
    key: 'renderMonthTitle',
    value: function () {
      function renderMonthTitle(isYearsEnabled, monthTitle) {
        if (isYearsEnabled) {
          var monthParts = monthTitle.split(' ');

          return _react2['default'].createElement('div', {
            id: 'CalendarMonth__caption',
            className: 'CalendarMonth__caption js-CalendarMonth__caption'
          }, _react2['default'].createElement('strong', { className: 'CalendarMonth__caption__month' }, monthParts[0]), _react2['default'].createElement('strong', { className: 'CalendarMonth__caption__year' }, monthParts[1]));
        }

        return _react2['default'].createElement('div', {
          id: 'CalendarMonth__caption',
          className: 'CalendarMonth__caption js-CalendarMonth__caption'
        }, _react2['default'].createElement('strong', null, monthTitle));
      }
  ...
  _createClass(CalendarMonth, [{
    ...
    value: function () {
      function render() {
        ...
        return _react2['default'].createElement('div', { className: calendarMonthClasses, 'data-visible': isVisible }, CalendarMonth.renderMonthTitle(isYearsEnabled, monthTitle), _react2['default'].createElement('table', { role: 'presentation' }, _react2['default'].createElement('tbody', { className: 'js-CalendarMonth__grid' }, weeks.map(function (week, i) {
