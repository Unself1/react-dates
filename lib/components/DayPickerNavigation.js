...
function DayPickerNavigation(props) {
  var navPrev = props.navPrev,
      ...
      onPrevYearClick = props.onPrevYearClick,
      onNextYearClick = props.onNextYearClick,
      orientation = props.orientation,
      phrases = props.phrases,
      isRTL = props.isRTL,
      isYearsEnabled = props.isYearsEnabled;
  ...
  var prevMonthClassNames = (0, _classnames2['default'])('DayPickerNavigationMonth__prev', {
    'DayPickerNavigationMonth__prev--default': isDefaultNavPrev,
    'DayPickerNavigationMonth__prev--rtl': isRTL
  });
  var nextMonthClassNames = (0, _classnames2['default'])('DayPickerNavigationMonth__next', {
    'DayPickerNavigationMonth__next--default': isDefaultNavNext,
    'DayPickerNavigationMonth__next--rtl': isRTL
  });
  var prevYearClassNames = (0, _classnames2['default'])('DayPickerNavigationYear__prev', {
    'DayPickerNavigationYear__prev--default': isDefaultNavPrev,
    'DayPickerNavigationYear__prev--rtl': isRTL
  });
  var nextYearClassNames = (0, _classnames2['default'])('DayPickerNavigationYear__next', {
    'DayPickerNavigationYear__next--default': isDefaultNavNext,
    'DayPickerNavigationYear__next--rtl': isRTL
  });

  return _react2['default'].createElement('div', { className: navClassNames }, _react2['default'].createElement('div', { className: 'DayPickerNavigationMonth' }, !isVerticalScrollable && _react2['default'].createElement('button', {
    type: 'button',
  ...
  }, navNextIcon)), isYearsEnabled && _react2['default'].createElement('div', { className: 'DayPickerNavigationYear' }, _react2['default'].createElement('button', {
    type: 'button',
    'aria-label': phrases.jumpToPrevMonth,
