...
module.exports = require("../utils/isSameMonth");
...
var _isSameMonth = __webpack_require__(50);
  ...
  _createClass(DayPickerSingleDateController, [{
    ...
    value: function () {
      function componentWillReceiveProps(nextProps) {
        ...
        var didDateChange = !(0, _moment2['default'])(date).isSame((0, _moment2['default'])(this.props.date), 'day');
        ...
        // update visible days since a day outside of the visible range was selected
        if (!(0, _isSameDay2['default'])(date, this.props.date) && !(0, _isSameMonth2['default'])(date, this.state.currentMonth)) {
          var _newMonthState = this.getStateForNewMonth(nextProps);
          var _currentMonth = _newMonthState.currentMonth;
          visibleDays = (0, _getVisibleDays2['default'])(_currentMonth, 1, enableOutsideDays);
          this.setState({
            currentMonth: _currentMonth,
            shouldResetToToday: true
          });
          modifiers = this.getModifiers(visibleDays);
          modifiers = this.addModifier(modifiers, date, 'selected', true);
        } else {
          this.setState({
            shouldResetToToday: false
          });
    ...
    value: function () {
      function onPrevYearClick() {
        ...
        var prevYear = currentMonth.clone().subtract(1, 'year');
        var prevYearVisibleDays = (0, _getVisibleDays2['default'])(prevYear, 1, enableOutsideDays);

        this.setState({
          currentMonth: prevYear,
          visibleDays: (0, _object4['default'])({}, this.getModifiers(prevYearVisibleDays))
        });
    ...
    value: function () {
      function onNextYearClick() {
        ...
        var nextYear = currentMonth.clone().add(numberOfMonths + 12, 'month');
        var nextYearVisibleDays = (0, _getVisibleDays2['default'])(nextYear, 1, enableOutsideDays);

        var newCurrentYear = currentMonth.clone().add(1, 'year');

        this.setState({
          currentMonth: newCurrentYear,
          visibleDays: (0, _object4['default'])({}, this.getModifiers(nextYearVisibleDays))
        });
    ...
    value: function () {
      function addModifier(updatedDays, day, modifier) {
        ...
        if (!day || !force && !(0, _isDayVisible2['default'])(day, currentMonth, numberOfMonths, enableOutsideDays)) {
          return updatedDays;
        }
    ...
    value: function () {
      function render() {
        var _props10 = this.props,
            ...
            isYearsEnabled = _props10.isYearsEnabled,
        ...
        var _state7 = this.state,
            ...
            _shouldResetToToday = _state7.shouldResetToToday;
        ...
        var dayPickerComponent = _react2['default'].createElement(_DayPicker2['default'], {
          ...
          shouldResetToToday: function () {
            function shouldResetToToday() {
              return _shouldResetToToday;
            }

            return shouldResetToToday;
          }()
        });
