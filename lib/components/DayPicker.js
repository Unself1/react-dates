...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  shouldResetToToday: _propTypes2['default'].func,
...
var DayPicker = function (_React$Component) {
  ...
  function DayPicker(props) {
    ...
    _this.returnToToday = _this.returnToToday.bind(_this);
  ...
  _createClass(DayPicker, [{
    ...
    value: function () {
      function componentWillReceiveProps(nextProps) {
        var hidden = nextProps.hidden,
            ...
            shouldResetToToday = nextProps.shouldResetToToday;
    ...
    value: function () {
      function onPrevYearClick(e) {
        var onPrevYearClick = this.props.onPrevYearClick;
        var currentMonth = this.state.currentMonth;

        if (e) e.preventDefault();

        var translationValue = 0;
        var newCurrentMonth = currentMonth.clone().subtract(1, 'year');

        if (onPrevYearClick) onPrevYearClick(newCurrentMonth);
    ...
    value: function () {
      function onNextYearClick(e) {
        var onNextYearClick = this.props.onNextYearClick;
        var currentMonth = this.state.currentMonth;

        if (e) e.preventDefault();

        var translationValue = 0;
        var newCurrentMonth = currentMonth.clone().add(1, 'year');

        if (onNextYearClick) onNextYearClick(newCurrentMonth);
    ...
    value: function () {
      function returnToToday() {
        var translationValue = 0;
        var newCurrentMonth = (0, _moment2['default'])();
    ...
    value: function () {
      function renderNavigation() {
        ...
        var _props3 = this.props,
            ...
            isRTL = _props3.isRTL,
            isYearsEnabled = _props3.isYearsEnabled;
