  ...
  _createClass(DayPickerRangeController, [{
    ...
    value: function () {
      function onPrevYearClick() {
        ...
        var prevYearCurrentMonth = currentMonth.clone().subtract(1, 'year');
        var prevYearPrevMonth = currentMonth.clone().subtract(11, 'month');
        var prevYearNextMonth = currentMonth.clone().subtract(13, 'month');
        var prevYearCurrentMonthVisibleDays = (0, _getVisibleDays2['default'])(prevYearCurrentMonth, 1, enableOutsideDays, true);
        var prevYearPrevMonthVisibleDays = (0, _getVisibleDays2['default'])(prevYearPrevMonth, 1, enableOutsideDays, true);
        var prevYearNextMonthVisibleDays = (0, _getVisibleDays2['default'])(prevYearNextMonth, 1, enableOutsideDays, true);

        this.setState({
          currentMonth: prevYearCurrentMonth,
          visibleDays: (0, _object4['default'])({}, this.getModifiers(prevYearPrevMonthVisibleDays), this.getModifiers(prevYearCurrentMonthVisibleDays), this.getModifiers(prevYearNextMonthVisibleDays))
        });
    ...
    value: function () {
      function onNextYearClick() {
        ...
        var nextYearCurrentMonth = currentMonth.clone().add(1, 'year');
        var nextYearPrevMonth = currentMonth.clone().add(11, 'month');
        var nextYearNextMonth = currentMonth.clone().add(13, 'month');
        var nextYearCurrentMonthVisibleDays = (0, _getVisibleDays2['default'])(nextYearCurrentMonth, 1, enableOutsideDays, true);
        var nextYearPrevMonthVisibleDays = (0, _getVisibleDays2['default'])(nextYearPrevMonth, 1, enableOutsideDays, true);
        var nextYearNextMonthVisibleDays = (0, _getVisibleDays2['default'])(nextYearNextMonth, 1, enableOutsideDays, true);

        this.setState({
          currentMonth: nextYearCurrentMonth,
          visibleDays: (0, _object4['default'])({}, this.getModifiers(nextYearPrevMonthVisibleDays), this.getModifiers(nextYearCurrentMonthVisibleDays), this.getModifiers(nextYearNextMonthVisibleDays))
        });
    ...
    value: function () {
      function render() {
        var _props19 = this.props,
            ...
            isYearsEnabled = _props19.isYearsEnabled,
